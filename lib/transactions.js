...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.kalycoind.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    isklc20Transfer: transaction.isklc20Transfer,
  };
...
TxController.prototype.transformKalycoinTransaction = function(transaction) {
